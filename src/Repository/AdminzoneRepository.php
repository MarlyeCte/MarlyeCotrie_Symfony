...
class AdminzoneRepository extends ServiceEntityRepository
{
    ...
    public function add(Adminzone $entity, bool $flush = false): void
    {
    ...
    public function remove(Adminzone $entity, bool $flush = false): void
    {
...
//    /**
//     * @return Adminzone[] Returns an array of Adminzone objects
//     */
...
//    public function findOneBySomeField($value): ?Adminzone
//    {
//        return $this->createQueryBuilder('a')
//            ->andWhere('a.exampleField = :val')
//            ->setParameter('val', $value)
